      ...
      <div className="bg-[url('/background.svg')] relative pt-[20vw] bg-no-repeat bg-cover h-[150vh] w-full">
        <div className="px-[10vw] flex flex-col justify-between">
          ...
          <div className="text-center rounded-[5vw] p-[1vw] bg-[#FDEBD2] outline-[0.5vw] outline-[#E8DDCA]">
            ...
            >
              Minis was born from a simple yet powerful idea: to create
              miniature delights that bring joy. Founded by a team of food
              enthusiasts, we've dedicated ourselves to crafting bite-sized
              treats that not only satisfy your taste buds but also brighten
              your day. Our journey began with the vision of redefining
              snacking.
            </p>
          </div>
        </div>
